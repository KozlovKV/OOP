...
public final class DatagramUtils {
     ...
     */
    public static String extractContentFromPacket(DatagramPacket packet) {
     ...
     */
    public static DatagramPacket createPacket(String str) {
     ...
     */
    public static DatagramPacket createPacket(String str, InetAddress addr, int port) {
