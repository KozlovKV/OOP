...
public class MainTest {
    ...
    void voidTest() {
        HeapSorter hs = new HeapSorter();
        hs.heapsort(new int[] {});
        Assertions.assertArrayEquals(new int[] {}, hs.getArr());
    }
    ...
    void intMaxMin() {
        ...
        Assertions.assertArrayEquals(new int[] {-2147483648, 2147483647}, hs.getArr());
    }
    ...
    void largeTest() {
        ...
        hs.heapsort(new int[] {1287215632, -141299706, -1008088036, 116536236,
            ...
            657504910});
        Assertions.assertArrayEquals(new int[] {-1660231475, -1589796938, -1073373868,
